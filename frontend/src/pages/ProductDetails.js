...
import CategoryWiseProductDisplay from '../components/CategotyWiseProductDisplay';
    ...
    <div className='container mx-auto p-4'>
        ...
        {/**product details */}
      {
        loading ? (
          ...
          <p className='bg-pink-300 text-pink-600 px-2 rounded-full inline-block w-fit'>{data?.brandName}</p>
